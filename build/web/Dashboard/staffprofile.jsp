                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" disabled name="emp_id" value="<%=rs.getString(1)%>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Email address</label>
                                                <input type="email" class="form-control" name="email" value="<%=rs.getString(7)%>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" name="pass" id="pass" value="<%=rs.getString(8)%>"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                     <a href="#">
                                    <img class="avatar border-gray" src="assets/img/icon2.jpg" alt="..."/>
                                ...
                                <p class="description text-center"> Assistant Professor<br>
                                                    Civil department <br>
